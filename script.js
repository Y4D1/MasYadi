...
footer.href = "https://www.instagram.com/yadi_fernando123/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Awas saja kalo boong😡🤬", "", "error").then(function () {
        ...
        const {
          ...
          inputValidator: (value) => {
            if (!value) {
              return 'Isi dulu lah sayangku cintaku'
            } else {
              nama = value;
            }
          }
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Oh gitu ya, oke gpp kok', '', 'error').then(function () {
